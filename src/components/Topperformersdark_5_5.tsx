...
export default function TopPerformersDark() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-8xl mx-auto w-full relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0b1739] via-[#101d4a] to-[#132257] px-6 sm:px-10 pt-3 pb-9 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)]">
        ...
        {/* all 10 performers, uniform size, 5 per row */}
        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4 mt-2 sm:mt-3">
          {PERFORMERS.map((p) => (
